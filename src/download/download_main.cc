...
DownloadMain::stop() {
  ...
  // Flush dirty mappings and release FDs while remaining open. Start already
  // close_all_files() before reopening; stop should not hold files open idle.
  // prepare() reopens on demand for hashing or the next start.
